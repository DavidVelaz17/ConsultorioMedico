...
public interface AppointmentRepository extends JpaRepository<Appointment, Integer> {
    ...
    boolean existsByDoctorIdAndDateAndHourAndIdNot(Integer doctorId, LocalDate date, Hour hour,Integer id);
    boolean existsByPatientIdAndDateAndHourAndIdNot(Integer patientId, LocalDate date, Hour hour,Integer id);
}
