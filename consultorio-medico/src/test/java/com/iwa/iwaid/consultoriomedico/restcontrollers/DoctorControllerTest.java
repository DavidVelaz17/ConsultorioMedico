...
class DoctorControllerTest {
    ...
    @BeforeEach
    void setUp() {
        doctors=new Doctors(2,"juan","surgery","achu #4",2722894059L,"juan@gmail.com");
...
/*TODO IWAID-20
    ...
    void testGetDoctor() throws Exception {
       when(doctorService.getDoctor(3))
                .thenReturn(Optional.ofNullable(doctors));
       this.mockMvc.perform(get("/iwaid/doctors/3"))
    ...
    void testSave() throws Exception {
        ...
        when(doctorService.saveDoctor(doctors))
                .thenReturn(doctors.getId());
    ...
    void testDelete() throws Exception {
        when(doctorService.deleteDoctor(2))
